    ...
    <div class="sounds">
      <div class="sound" v-for="(sound, index) in sounds" :key="index">
        <div class="sound-box" :class="{ play: sound.play }">
          ...
          <button v-if="!sound.loading" class="button" @click="play(sound.audio, index); sound.play">Play</button>
          <button v-if="sound.loading" class="button loading" @click="play(sound.audio, index); sound.play">Loading...</button>
        </div>
      </div>
    </div>
    <div class="footer">
...
export default class Home extends Vue {
  ...
  public mounted() {
    this.sounds.forEach((sound, index) => {
      ...
      audio.addEventListener('canplaythrough', this.loadedAudio(index), false);
      sound.audio = audio;
    });
  }
